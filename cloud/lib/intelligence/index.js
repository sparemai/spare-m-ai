...
export function buildIntelligence({spans,previousSpans,infra,correlation}){
 ...
 return {
  ...
  baselines,
  evidence,
  capabilities:{trace_intelligence:true,semantic_classification:true,journey_discovery:true,entity_baselines:true,evidence_graph:true,agentic_investigation:Boolean(process.env.OPENAI_API_KEY),adaptive_telemetry:false,profiles:false,change_intelligence:false,incident_memory:false}
 };
}
