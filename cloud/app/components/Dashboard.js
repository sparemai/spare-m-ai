...
function KPIs({data}){
 ...
 const cards=[
  ...
  [b.revenue_observed!==null&&b.revenue_observed!==undefined?'Revenue observed':b.transaction_value_observed!==null&&b.transaction_value_observed!==undefined?'Business value observed':'Completion proxy',b.revenue_observed!==null&&b.revenue_observed!==undefined?((b.currency?b.currency+' ':'')+Number(b.revenue_observed).toLocaleString()):b.transaction_value_observed!==null&&b.transaction_value_observed!==undefined?((b.currency?b.currency+' ':'')+Number(b.transaction_value_observed).toLocaleString()):pct(b.completion_proxy_pct),b.revenue_observed!==null&&b.revenue_observed!==undefined?'Trusted confirmed-booking revenue':b.transaction_value_observed!==null&&b.transaction_value_observed!==undefined?'Trusted confirmed-booking value':'Search → Confirm','business'],
